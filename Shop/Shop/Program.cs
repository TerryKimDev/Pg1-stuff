...
namespace Shop
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            string Pname;
            Console.SetCursorPosition(30, 15); //Saw example from below and used part of it to center this
            Console.Write("Welcome to the shop. What is your name?: __________\b\b\b\b\b\b\b\b\b\b");
            ...
            while (true)
            {
                ...
                do
                {
                    ...
                    ShowInventories(Pname, PlayerInv, StoreInv);
                ...
                DoTransaction(Pname, PlayerInv, StoreInv, doBuy);
            }
